...
(
	...
	CONSTRAINT CK2_CABALLOS CHECK (PESO > 240 AND PESO < 300)
);
...
(
	...
	APUESTA_LIMITE NUMBER(5.2) CHECK (APUESTA_LIMITE > 20000),
...
(
	...
	POSICION_FINAL NUMBER(2) CHECK (POSICION_FINAL > 0),
...
(
	...
	CONSTRAINT CK_CLIENTES CHECK REGEXP_LIKE(DNI, '^[0-9]{8}[A-Z]$')
);
...
(
	...
	CODCABALLO VARCHAR2(4),
	CODCARRERA VARCHAR2(4),
	IMPORTE NUMBER(6) NOT NULL SET DEFAULT 300,
