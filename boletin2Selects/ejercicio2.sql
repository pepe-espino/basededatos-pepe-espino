...
JOIN PROFESOR p ON P.IDPROFESOR = A.IDPROFESOR 
JOIN PERSONA p2 ON P2.DNI = P.DNI
WHERE UPPER(P2.NOMBRE) LIKE 'ROSA GARCIA';

--9

SELECT A.DNI FROM ALUMNO a 
JOIN PERSONA p ON A.DNI = P.DNI 
JOIN PROFESOR p2 ON P2.DNI = P.DNI 
...
JOIN ASIGNATURA a2 ON AA.IDASIGNATURA = A2.IDASIGNATURA 
JOIN PROFESOR p2 ON A2.IDPROFESOR = P2.IDPROFESOR 
WHERE UPPER(P.NOMBRE) LIKE 'JORGE' AND UPPER(P.APELLIDO) LIKE 'SAENZ';
